...
import { useGetCategoryQuery } from "@/redux/features/products/category.api";
...
const CategoriesLayout = ({ id }: CategoriesLayoutProps) => {
  ...
  const filterOptions = data?.products?.filterOptions;
      ...
      <main>
        ...
        <section aria-labelledby="products-heading" className="pt-6">
          ...
          <div className="flex flex-col lg:flex-row gap-x-8">
            {data && (
              <div className="sticky top-0 h-max hidden lg:block">
